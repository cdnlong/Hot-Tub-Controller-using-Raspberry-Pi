...
mysqli_query($m_connect,"UPDATE relays SET name='$name', pin='$pin', power='$power' WHERE id='$id' LIMIT 1");
alert("Relay changed.");
return;
}
...
mysqli_query($m_connect,"INSERT INTO relays (id,name,pin) VALUES('','$name','$pin')");
alert("Relay Added.");
return;
}
