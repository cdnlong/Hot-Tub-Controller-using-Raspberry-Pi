...
mysqli_query($m_connect,"UPDATE sensors SET address='$address', name='$name', calibration_value='$calibration' WHERE id='$id' LIMIT 1");
...
mysqli_query($m_connect,"INSERT INTO sensors (id,address,name,calibration_value) VALUES('','$address','$name','$calibration')");
alert("Sensor Added.");
return;
}
